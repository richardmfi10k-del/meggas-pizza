...
// VERSIÓN ACTUALIZADA — con notificaciones push + botón imprimir tiquete
...
export default function KitchenPage() {
  ...
  const [printOrder, setPrintOrder] = useState(null); // pedido a imprimir
  ...
  async function handleEnableNotifications() {
    ...
    setActivating(false);
    setNotifMsg(ok
      ? "✅ Notificaciones activadas. Te avisaremos aunque cierres esta pestaña."
